const AdminHeader = (props) => {
  ...
  return (
    <div
      className="flex h-20 w-full mx-auto items-center justify-between z-50 p-5 sticky top-0 backdrop-blur-md"
      style={getBackgroundStyle()}
    >
      <div className="">
        <a href="#" className="flex flex-row gap-5 items-center text-center">
          <img src={logo?.text || ""} alt="Logo" className="w-12 h-12" />
              ...
              return (
                <div key={idx}>
                  <a
                    ...
                    className="text-(--item-color) transition-colors hover:text-[#E91E8C]"
                  >
                    {content}
                  </a>
                </div>
